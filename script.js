    ...
    document.getElementById('register-container').innerHTML = `
      <div class="form-step">
        ...
        <div class="button-grid" style="grid-template-columns: 1fr;">
          <button class="grid-button" onclick="handleBuildingSelect('19А')">19А</button>
        </div>
      </div>`;
}
        ...
        data.meters.forEach(m => {
            ...
            html += `
              <div class="meter-card">
                ...
                <p><strong>Показания (прошлый месяц) от ${m.initial_reading_date}:</strong> <code>${last}</code></p>
